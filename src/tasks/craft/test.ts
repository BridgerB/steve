...
import { craftPlanks, craftCraftingTable, craftSticks, craftWoodenPickaxe } from "./main.ts";
...
it("craft: place table + craft wooden pickaxe", { timeout: 60000 }, async () => {
  await runBotTest({
    username: "TestCraft",
    setupCommands: [
...
it("craft: full chain — 3 logs → wooden pickaxe", { timeout: 60000 }, async () => {
  await runBotTest({
    username: "TestCraft",
    setupCommands: [
      "/tp TestCraft 150 71 150",
